...
通过包含1、71、91和111个跨领域概念的四规模实验，模型在预设算法范式中分别实现了23.1\%、15.5\%、12.2\%和7.6\%的平均能耗降低，而在自然涌现范式中分别实现了88.0\%、72.3\%、61.4\%和47.9\%的显著优化。实验产生了大量高度合理的概念压缩和原理迁移，所有压缩均达到完全内聚性（1.0），迁移效率达到0.35-0.52。
